...
raw_ensg_df = pd.read_csv(OUTPUT_PATH / "raw_ensg_df.csv")
total_raw_gene_record_set_ensg = set(raw_ensg_df['ENSG_ID'])

raw_ncbi_df = pd.read_csv(OUTPUT_PATH / "raw_ncbi_df.csv")
total_raw_gene_record_set_ncbi = set(raw_ncbi_df['NCBI_ID'])



merged_alias_ap_collision_hgnc_df = pd.read_csv(OUTPUT_PATH / "merged_alias_ap_collision_hgnc_df.csv")
...
merged_alias_ap_collision_ensg_df = pd.read_csv(OUTPUT_PATH / "merged_alias_ap_collision_ensg_df.csv")
...
merged_alias_ap_collision_ncbi_df = pd.read_csv(OUTPUT_PATH / "merged_alias_ap_collision_ncbi_df.csv")
...
merged_alias_aa_collision_ensg_df = pd.read_csv(OUTPUT_PATH / "merged_alias_aa_collision_ensg_df.csv")
...
merged_alias_aa_collision_ncbi_df = pd.read_csv(OUTPUT_PATH / "merged_alias_aa_collision_ncbi_df.csv")
...
mini_ensg_df = pd.read_csv(OUTPUT_PATH / "mini_ensg_df.csv")

gene_record_set_ensg = set(mini_ensg_df["ENSG_ID"])
gene_record_count_ensg = len(gene_record_set_ensg)

mini_ncbi_df = pd.read_csv(OUTPUT_PATH / "mini_ncbi_df.csv")
